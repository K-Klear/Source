...
embedded_components {
  id: "spawn_goblin_worker"
  type: "factory"
  data: "prototype: \"/main/Actors/dwellers/goblin_worker.go\"\n"
  "load_dynamically: false\n"
  ""
  position {
    x: 0.0
...
embedded_components {
  id: "spawn_orc"
  type: "factory"
  data: "prototype: \"/main/Actors/dwellers/orc.go\"\n"
  "load_dynamically: false\n"
  ""
  position {
    x: 0.0
...
embedded_components {
  id: "spawn_drake_boss"
  type: "factory"
  data: "prototype: \"/main/Actors/dwellers/drake_boss.go\"\n"
  "load_dynamically: false\n"
  ""
  position {
    x: 0.0
